...
export function HeroCleanerPlaceholder() {
  return (
    <div className="relative min-h-[360px] overflow-hidden rounded-bl-[80px] bg-[linear-gradient(135deg,#ecfeff_0%,#ffffff_42%,#f0f9ff_100%)] md:min-h-[470px]">
      <div className="absolute left-6 top-14 hidden text-cyan-200 md:block">
        <SparkleIcon className="h-12 w-12" />
      </div>
      <div className="absolute left-20 top-28 hidden text-sky-200 md:block">
        <SparkleIcon className="h-9 w-9" />
      </div>
      <div className="absolute bottom-0 right-4 h-[88%] w-[76%] rounded-t-[48%] bg-white/75 shadow-[inset_0_0_80px_rgba(6,182,212,0.10)]" />
      <div className="absolute bottom-0 right-10 flex h-[92%] w-[68%] items-end justify-center">
        <div className="relative h-[92%] w-full max-w-[360px]">
          ...
          <div className="absolute left-1/2 top-36 h-48 w-44 -translate-x-1/2 rounded-t-3xl bg-cyan-700 shadow-[0_18px_42px_rgba(14,138,141,0.28)]">
            <div className="absolute left-1/2 top-12 h-16 w-24 -translate-x-1/2 rounded-lg border-2 border-white/70">
              ...
              <span className="absolute bottom-3 left-1/2 h-1 w-14 -translate-x-1/2 rounded-full bg-sky-300" />
            </div>
          </div>
          <div className="absolute bottom-20 left-2 h-20 w-28 -rotate-12 rounded-full bg-sky-300" />
          <div className="absolute bottom-20 right-1 h-20 w-28 rotate-12 rounded-full bg-sky-300" />
          <div className="absolute bottom-14 right-5 flex h-28 w-40 items-end justify-center rounded-b-[36px] rounded-t-lg border-4 border-cyan-700 bg-cyan-50">
            <div className="h-24 w-8 rounded-t-lg bg-white shadow-sm" />
            <div className="mx-2 h-32 w-9 rounded-t-lg bg-white shadow-sm">
              <div className="mx-auto mt-2 h-4 w-5 rounded bg-cyan-500" />
            </div>
...
export function ProfessionalCtaPlaceholder() {
  return (
    <div className="relative h-28 w-32 overflow-hidden rounded-lg bg-cyan-50">
      ...
      <div className="absolute bottom-0 left-1/2 h-16 w-24 -translate-x-1/2 rounded-t-3xl bg-cyan-700" />
      <div className="absolute bottom-8 left-6 h-6 w-12 -rotate-12 rounded-full bg-sky-300" />
      <div className="absolute bottom-8 right-6 h-6 w-12 rotate-12 rounded-full bg-sky-300" />
    </div>
  );
}
...
export function HomeSparkPlaceholder() {
  return (
    <div className="flex h-24 w-28 items-center justify-center rounded-lg bg-cyan-50 text-cyan-700">
      <div className="relative h-16 w-16">
        ...
        <CheckCircleIcon className="absolute -right-2 -top-1 h-7 w-7 text-cyan-500" />
      </div>
    </div>
  );
}
